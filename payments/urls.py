...
from .views import CreatePaymentView, VerifyPaymentView, PaymentStatusView, TestPaymentSuccessView, RazorpayMethodsView
...
urlpatterns = [
    ...
    path('methods/',                RazorpayMethodsView.as_view(),      name='payment-methods'),
]
