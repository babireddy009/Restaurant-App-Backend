...
menu_items = [
    ...
    # Main Course
    {'category': 'Main Course', 'name': 'Butter Chicken', 'description': 'Tender chicken in rich tomato-based creamy sauce', 'price': 349.00, 'is_vegetarian': False, 'is_featured': True, 'is_bestseller': True, 'spice_level': 'mild', 'rating': 4.8, 'rating_count': 500},
    ...
    # Biryani
    {'category': 'Biryani & Rice', 'name': 'Chicken Biryani', 'description': 'Fragrant basmati rice cooked with tender chicken and whole spices', 'price': 359.00, 'is_vegetarian': False, 'is_featured': True, 'is_bestseller': True, 'spice_level': 'medium', 'rating': 4.9, 'rating_count': 650},
    {'category': 'Biryani & Rice', 'name': 'Veg Biryani', 'description': 'Aromatic basmati rice with seasonal vegetables and saffron', 'price': 279.00, 'is_vegetarian': True, 'is_featured': True, 'spice_level': 'medium', 'rating': 4.3, 'rating_count': 220},
    ...
    {'category': 'Breads', 'name': 'Garlic Naan', 'description': 'Naan topped with minced garlic and coriander', 'price': 59.00, 'is_vegetarian': True, 'is_bestseller': True, 'spice_level': 'none', 'rating': 4.7, 'rating_count': 280},
    ...
    # Desserts
    {'category': 'Desserts', 'name': 'Gulab Jamun', 'description': 'Soft khoya dumplings soaked in rose-flavored syrup', 'price': 99.00, 'is_vegetarian': True, 'is_bestseller': True, 'spice_level': 'none', 'rating': 4.7, 'rating_count': 420},
    ...
    {'category': 'Beverages', 'name': 'Mango Lassi', 'description': 'Creamy mango and yogurt blended drink', 'price': 99.00, 'is_vegetarian': True, 'is_featured': True, 'spice_level': 'none', 'rating': 4.8, 'rating_count': 270},
    ...
    # Burgers
    {'category': 'Burgers', 'name': 'Classic Chicken Burger', 'description': 'Crispy fried chicken with lettuce, tomato and mayo', 'price': 199.00, 'is_vegetarian': False, 'is_bestseller': True, 'spice_level': 'mild', 'rating': 4.5, 'rating_count': 320},
...
for item_data in menu_items:
    ...
    print(f"{'Created' if created else 'Exists'}: MenuItem '{item.name}' (Rs.{item.price})")
